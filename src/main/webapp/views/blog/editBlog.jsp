...
<div class="main">
    <div class="container">
        ...
        <div class="content-course">
            <form class="form-horizontal news-add" style="padding:50px" action="${rootPath}/blog/update/${blog.id}" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <textarea  name="content" id="editor" class="form-control" rows="3" value="${blog.content}"></textarea>
                    </div>
                </div>
<%--                <div class="form-group">

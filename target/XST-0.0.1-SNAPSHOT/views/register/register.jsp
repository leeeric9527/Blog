...
<body>
<div class="wrapper">
	<h1>Hero Union Blog</h1>
	<h2>Failure is the mother of success</h2>
	...
	<div class="content">
		<div id="form_wrapper" class="form_wrapper">
			<form class="register active" id="loginForm" action="${rootPath}/user/register" method="post">
				...
				<div class="column">
					...
					<div>
						...
						&nbsp	&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input name="sex" type="radio" value="男" checked="true"/>男
			...
			<form class="login" id="loginForm0" action="${rootPath}/user/login" method="post">
				<h3>Login</h3>
				<div>
					<label>Username:</label>
					<input type="text" name="username"/>
				...
				<div class="bottom">
					...
					<input type="submit" value="Login" onclick="return userLoginSubmit()"/>
	...
	<a class="back" href="${rootPath}/index">Blog</a>
</div>
...
<script>
	function userLoginSubmit() {
		...
		$.ajax({
			...
			data: $('#loginForm0').serialize(),    //   字符串  name1=value1&name2=value2
			success: function(loginMsg) {
				console.log(loginMsg)
				if( loginMsg.status ) {
					//alert('登陆成功');

...
<%--            <div class="breadcrumb-wrapper">
                <ol class="breadcrumb">
                    <li class="btnWrite">
                        ...
                        <span>
                         <img src="${assetsPath}/images/ico_write.ico">
                            写新博客
                        </span>
                        </a>
                    </li>
            ...
            <div class="navigator" style="margin:5px 5px ">
                <ul style="margin-left: 1030px">
                    <li class="btnWrite">
                        <a href="${rootPath}/blog/list/${sessionScope.user.id}" style="text-decoration: none">
                        <span>
                         <img src="${assetsPath}/images/ico_guan.ico">
                            管理博客
                        </span>
                        </a>
                    </li>
